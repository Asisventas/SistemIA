...
namespace SistemIA.Migrations
{
    ...
    [Migration("20260217132740_Add_MedioPagoSena_TurnoSena_IdCajaSena")]
    partial class Add_MedioPagoSena_TurnoSena_IdCajaSena
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SistemIA.Models.AsistenteIA.ConfiguracionAsistenteIA", b =>
                {
                    ...
                    b.Property<string>("ApiKeyCentral")
                        .HasMaxLength(200)
                        .HasColumnType("nvarchar(200)");

                    b.Property<string>("ApiSecretCentral")
                        .HasMaxLength(200)
                        .HasColumnType("nvarchar(200)");

                    b.Property<string>("BaseDatosCentral")
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)");

                    b.Property<bool?>("ConexionCentralExitosa")
                        .HasColumnType("bit");

                    b.Property<string>("ContrasenaCentral")
                        .HasMaxLength(200)
                        .HasColumnType("nvarchar(200)");
                    ...
                    b.Property<bool>("HabilitarServidorCentral")
                        .HasColumnType("bit");
                    ...
                    b.Property<string>("ModoConexionCentral")
                        .IsRequired()
                        .HasMaxLength(10)
                    ...
                    b.Property<int>("PuertoCentral")
                        .HasColumnType("int");

                    b.Property<string>("ServidorCentral")
                        .HasMaxLength(200)
                        .HasColumnType("nvarchar(200)");

                    b.Property<int>("TimeoutConexionCentral")
                        .HasColumnType("int");

                    b.Property<DateTime?>("UltimaVerificacionCentral")
                        .HasColumnType("datetime2");

                    b.Property<string>("UrlApiCentral")
                        .HasMaxLength(500)
                        .HasColumnType("nvarchar(500)");

                    b.Property<bool>("UsarWindowsAuthCentral")
                        .HasColumnType("bit");

                    b.Property<string>("UsuarioCentral")
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)");
            ...
            modelBuilder.Entity("SistemIA.Models.ConfiguracionSistema", b =>
                {
                    ...
                    b.Property<int>("SifenIntervaloMinutos")
                        .HasColumnType("int");

                    b.Property<int>("SifenMaxDocumentosPorCiclo")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SistemIA.Models.Gimnasio.PlanMembresia", b =>
                {
                    b.Property<int>("IdPlan")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<bool>("AccesoTodasAreas")
                        .HasColumnType("bit");

                    b.Property<bool>("Activo")
                        .HasColumnType("bit");

                    b.Property<string>("AreasIncluidas")
                        .HasMaxLength(500)
                        .HasColumnType("nvarchar(500)");

                    b.Property<int>("ClasesIncluidasPorPeriodo")
                        .HasColumnType("int");
                    ...
                    b.Property<string>("DiasAcceso")
                        .HasMaxLength(20)
                        .HasColumnType("nvarchar(20)");

                    b.Property<int>("DiasCongelamientoMaximo")
                        .HasColumnType("int");

                    b.Property<int>("DiasGracia")
                        .HasColumnType("int");

                    b.Property<int>("DiasRecordatorioVencimiento")
                        .HasColumnType("int");
                    ...
                    b.Property<string>("HorarioAcceso")
                        .HasMaxLength(50)
                        .HasColumnType("nvarchar(50)");
                    ...
                    b.Property<bool>("IncluyePersonalTrainer")
                        .HasColumnType("bit");
                    ...
                    b.Property<int?>("SesionesPTIncluidas")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SistemIA.Models.Reserva", b =>
                {
                    ...
                    b.Property<int?>("TurnoSena")
                        .HasColumnType("int");

                    b.HasKey("IdReserva");

                    b.HasIndex("CajaSenaIdCaja");
            ...
            modelBuilder.Entity("SistemIA.Models.Gimnasio.MembresiaCliente", b =>
                {
                    ...
                    b.HasOne("SistemIA.Models.Gimnasio.PlanMembresia", "Plan")
                        .WithMany()
            ...
            modelBuilder.Entity("SistemIA.Models.Reserva", b =>
                {
                    b.HasOne("SistemIA.Models.Caja", "CajaSena")
                        .WithMany()
                        .HasForeignKey("CajaSenaIdCaja");

...
{
    /// <summary>
    /// OBSOLETO: Este modelo es el modelo antiguo de proveedores.
    /// Use ProveedorSifenMejorado para nuevas funcionalidades.
    /// Mantenido por compatibilidad con datos históricos.
    /// </summary>
    [Obsolete("Use ProveedorSifenMejorado en su lugar")]
    [Table("Proveedores")]
